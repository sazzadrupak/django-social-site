...
urlpatterns = [
    ...
    path('discussion/', include(('discussion.urls', 'discussion'), namespace='discussion')),
    path('admin/', admin.site.urls),
    path('auth/', include('social_django.urls', namespace='social')),  # for social login authentication
]
